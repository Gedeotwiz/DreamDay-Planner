...
const provinces = [
  ...
  { name: "Southern Province", coordinates: [29.7516, -2.6000] },
  { name: "Eastern Province", coordinates: [30.4356, -1.5000] },
  { name: "Western Province", coordinates: [29.3275, -2.0500] }
];
  ...
  return (
    ...
    <ExplanationLocation/>
      <div className="w-full max-w-4xl h-[300px] md:h-[680px] bg-secondary rounded-xl shadow-md p-2">
        <ComposableMap projection="geoMercator" projectionConfig={{ center: [30.0, -1.9], scale: 3000 }}>
          <ZoomableGroup center={[30.0, -1.9]} zoom={5}>
            ...
            {provinces.map((prov, index) => (
              <Marker key={index} coordinates={prov.coordinates}>
                <circle
                  r={1}
                  fill="#ef4444"
                  stroke="#fff"
